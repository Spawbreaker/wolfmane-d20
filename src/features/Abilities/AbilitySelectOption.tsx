...
export const StyledAbilitySelectOption = styled(Box) <{ selected: boolean }>`
...
export const AbilitySelectOption: React.FC<Props> = ({ name, description, charges, selected, onClick }) => {
  return (
    <StyledAbilitySelectOption selected={selected} onClick={onClick}>
